...
figure
hold on
OFFLINE=true; % this variable indicates whtether to use the precalculated data (true) or whether to do calculation again (false)

%% Calculate curves for dimensionality 100

warning off
clearvars -except OFFLINE
...
%% Calculate curves for dimensionality 100, 000

warning off
clearvars -except OFFLINE
d=100000; %Set the dimensionality of HD-vectors
DENS=0.01:0.01:0.5;  % a range of density of ones
maxb=5; %range of bit distortions
sim=100; %Set number of simulations for each noise level.
if OFFLINE%
    load('SIMUL_NEW_d_100000.mat')
else
    Scenario_recall_pattens_with_distortions_all_density
end
...
%% END Calculate curves for dimensionality 100, 000

%% Calculate curves for dimensionality 1, 000, 000

warning off
clearvars -except OFFLINE
d=1000000; %Set the dimensionality of HD-vectors
DENS=0.01:0.01:0.5;  % a range of density of ones
maxb=5; %range of bit distortions
sim=100; %Set number of simulations for each noise level.
if OFFLINE%
    load('SIMUL_NEW_d_1000000.mat')
else
    Scenario_recall_pattens_with_distortions_all_density
end
...
%% END Calculate curves for dimensionality 1, 000, 000