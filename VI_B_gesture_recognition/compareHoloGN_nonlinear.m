%Performs simulations for the case "binary; approx. nonlinear; majority rule; binary"
%AND
%Performs simulations for the case "binary; approx. nonlinear; CDT; binary"
...
% [L_SAMPL_DATA_5, SAMPL_DATA_5] = genTrainData (TS_COMPLETE_5, L_TS_COMPLETE_5, learningFrac, 'inorder');
 ...
 %%    
    ...
    iM = initItemMemoriesNonLinear(D, 21, 6,seed,density);
